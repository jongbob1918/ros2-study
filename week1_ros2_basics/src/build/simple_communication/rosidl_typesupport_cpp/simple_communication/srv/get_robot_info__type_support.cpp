...
static const _GetRobotInfo_Request_type_support_symbol_names_t _GetRobotInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_communication, srv, GetRobotInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_communication, srv, GetRobotInfo_Request)),
  }
};
...
{
  return &::simple_communication::srv::rosidl_typesupport_cpp::GetRobotInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_communication, srv, GetRobotInfo_Request)() {
  return get_message_type_support_handle<simple_communication::srv::GetRobotInfo_Request>();
}
...
static const _GetRobotInfo_Response_type_support_symbol_names_t _GetRobotInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_communication, srv, GetRobotInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_communication, srv, GetRobotInfo_Response)),
  }
};
...
{
  return &::simple_communication::srv::rosidl_typesupport_cpp::GetRobotInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_communication, srv, GetRobotInfo_Response)() {
  return get_message_type_support_handle<simple_communication::srv::GetRobotInfo_Response>();
}
...
typedef struct _GetRobotInfo_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _GetRobotInfo_Event_type_support_ids_t;

static const _GetRobotInfo_Event_type_support_ids_t _GetRobotInfo_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _GetRobotInfo_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _GetRobotInfo_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _GetRobotInfo_Event_type_support_symbol_names_t _GetRobotInfo_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_communication, srv, GetRobotInfo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_communication, srv, GetRobotInfo_Event)),
  }
};

typedef struct _GetRobotInfo_Event_type_support_data_t
{
  void * data[2];
} _GetRobotInfo_Event_type_support_data_t;

static _GetRobotInfo_Event_type_support_data_t _GetRobotInfo_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _GetRobotInfo_Event_message_typesupport_map = {
  2,
  "simple_communication",
  &_GetRobotInfo_Event_message_typesupport_ids.typesupport_identifier[0],
  &_GetRobotInfo_Event_message_typesupport_symbol_names.symbol_name[0],
  &_GetRobotInfo_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t GetRobotInfo_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_GetRobotInfo_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::simple_communication::srv::rosidl_typesupport_cpp::GetRobotInfo_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_communication, srv, GetRobotInfo_Event)() {
  return get_message_type_support_handle<simple_communication::srv::GetRobotInfo_Event>();
}
...
static const _GetRobotInfo_type_support_symbol_names_t _GetRobotInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_communication, srv, GetRobotInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_communication, srv, GetRobotInfo)),
  }
};
...
static const rosidl_service_type_support_t GetRobotInfo_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<simple_communication::srv::GetRobotInfo_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<simple_communication::srv::GetRobotInfo_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<simple_communication::srv::GetRobotInfo_Event>(),
...
{
  return &::simple_communication::srv::rosidl_typesupport_cpp::GetRobotInfo_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_communication, srv, GetRobotInfo)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<simple_communication::srv::GetRobotInfo>();
}
