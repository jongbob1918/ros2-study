...
class Metaclass_GetRobotInfo_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('simple_communication')
        except ImportError:
            import logging
            import traceback
...
class GetRobotInfo_Event(metaclass=Metaclass_GetRobotInfo_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<simple_communication/GetRobotInfo_Request, 1>',
        'response': 'sequence<simple_communication/GetRobotInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simple_communication', 'srv'], 'GetRobotInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simple_communication', 'srv'], 'GetRobotInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from simple_communication.srv import GetRobotInfo_Request
    ...
    def response(self, value):
        if self._check_fields:
            from simple_communication.srv import GetRobotInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetRobotInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'simple_communication.srv.GetRobotInfo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from simple_communication.srv import _get_robot_info
...
class GetRobotInfo(metaclass=Metaclass_GetRobotInfo):
    from simple_communication.srv._get_robot_info import GetRobotInfo_Request as Request
    from simple_communication.srv._get_robot_info import GetRobotInfo_Response as Response
    from simple_communication.srv._get_robot_info import GetRobotInfo_Event as Event
